...
@Index("rental_price", ["rentalPrice"], {})
@Index("rental_date", ["rentalDate"], {})
...
@Entity("last_rentals_old", { schema: "reborn_db" })
export class LastRentalsOld {
  ...
  @Column("bigint", { name: "rental_price", nullable: true })
  rentalPrice: string | null;

  @Column("datetime", { name: "rental_date", nullable: true })
  ...
  @Column("tinyint", { name: "stories", nullable: true, unsigned: true })
  stories: number | null;
